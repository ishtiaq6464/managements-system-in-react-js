    ...
    return (
       <div>
            ...
            <div className="container">
                <a class="navbar-brand mr-auto mr-lg-0" to="#">Offcanvas navbar</a>
                ...
                <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <Link class="nav-link" to="#">Notifications</Link>
                        </li>
                        <li class="nav-item">
                            <Link class="nav-link" to="#">Profile</Link>
                        </li>
                        <li class="nav-item">
                            <Link class="nav-link" to="#">Switch account</Link>
                        </li>
                        <li class="nav-item dropdown">
                            <Link class="nav-link dropdown-toggle" to="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Settings</Link>
